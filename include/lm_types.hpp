...
namespace tongrams {
#define MPH_COUNT_TYPE(HASH_KEY_BITS, DISTINCT_COUNT_BITS)               \
    mph_count_lm<                                                        \
...
// for print_stats.cpp
#define SXLM_TYPES                                                            \
    (mph3232_count_lm)(mph3264_count_lm)(mph6432_count_lm)(mph6464_count_lm)( \
        ...
        ef_trie_prob_lm)(pef_trie_prob_lm)(ef_rtrie_prob_lm)(                 \
        pef_rtrie_prob_lm)(mph32_prob_lm)(mph64_prob_lm)
